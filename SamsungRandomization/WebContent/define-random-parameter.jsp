					...
					<div class="span12 boxes">
						...
						<div class="box-content" id="random-area">
							<form class="form-horizontal">
								...
								<!-- input area for permuted block random-->
								...
								<!-- input area for stratified block-->
								<div id="option3" class="group">
									...
									<div class="row-fluid">
										...
										<input type="hidden" id="strata_count" value="0">
									</div>
								...
								<div id="option4" class="group">
									...
									<div class="row-fluid">
										...
										<input type="hidden" id="strata_count1" value="0">
									</div>
